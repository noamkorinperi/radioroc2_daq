...
int main(void)
{
  ...
  app_run();   /* does not return — contains the infinite loop */
  while (1)
  {
    /* USER CODE END WHILE */
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : ERRORN_OC_Pin */
  GPIO_InitStruct.Pin = ERRORN_OC_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(ERRORN_OC_GPIO_Port, &GPIO_InitStruct);
